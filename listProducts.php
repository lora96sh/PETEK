...
<body >
    ...
    <div class="container my-3">
     ...
     <br>
        <div>
        <button type="button" data-toggle="modal" data-target=".remove-list-modal" class="btn btn-primary">Delete List</button>
            <br><br>
            <h3>Products</h3>
    ...
    <div class="modal fade remove remove-list-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                </div><form id="listDelete" method="post" action="api/listApis.php"><input type="hidden" name="delList" value="1"></form>
