...
<body >
    ...
    <div class="container my-3">
     <h5>you logged in at <?=$loginDate?></h5>
        ...
        <a href="products.php"> <button type="button" id="productsList" class="btn btn-primary">Products List</button></a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalBodyaddProduct">
                        ...
                        <form id="addFamily" method="POST" action="api/addFamily.php">
                            <div class="row">
                                <div class="ui-widget">
                                    <div class="col md-6">
                                        <label for="prodName" class="">Family Name : </label><br>
                                        <input id="prodName" type="text" name="fName" class="form-control" placeholder="Enter Family Name"
                                               aria-describedby="helpId" required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" type="submit" class="btn btnAddProduct btn-primary">Add Family</button>
                        <button type="button" class="btn btn-secondary resetAddProductsForm" data-dismiss="modal">Done</button>
                    </div>
                </div>
            </div>
